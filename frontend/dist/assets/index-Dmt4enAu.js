...
`;const bt=({userName:e="Ali Yara",image:a,link:i=!1,status:f="offline",showStatus:c=!1,showStatusCircle:d=!1,showUserName:m=!1,size:y=40,isGroup:b=!1,bg:x=!1})=>{const v=s.jsxs(F9,{children:[s.jsx(q9,{bg:x,size:y,children:a?s.jsx("img",{src:a,alt:`${e} avatar`,loading:"lazy",width:y,height:y}):b?s.jsx(Nf,{}):s.jsx(T5,{})}),d&&s.jsx(V9,{children:s.jsxs(W9,{status:f,children:[f==="idle"&&s.jsx(K9,{}),f==="offline"&&s.jsx(eS,{})]})})]});return i?s.jsxs(cp,{children:[s.jsx($e,{to:"#",children:v}),m&&s.jsxs(up,{children:[s.jsx("h5",{children:e}),c&&s.jsx("span",{children:f})]})]}):s.jsxs(cp,{children:[v,m&&s.jsxs(up,{children:[s.jsx("h5",{children:e}),c&&s.jsx("span",{children:f})]})]})},cp=h.div`
  position: relative;
  display: flex;
  align-items: center;
  gap: 1rem;
...
`,DC=h.div`
  font-size: var(--text-sm);
  color: ${({theme:e})=>e.text.placeholder};
`,Ky=({})=>{const[e,a]=g.useState(!1),[i,f]=g.useState(!1),[c,d]=g.useState(!1),{friendRequests:m}=Hn(),y=cl(),{user:b,logout:x}=gt(),v=()=>{d(!1)},M=()=>{f(!e),a(k=>!k)},j=async()=>{try{await x()}catch(k){console.error("Logout failed:",k)}};return b?s.jsx(s.Fragment,{children:s.jsxs(AC,{children:[s.jsx(zC,{children:s.jsx(RC,{children:window.innerWidth<=700?s.jsx(s.Fragment,{children:s.jsxs(_C,{children:[s.jsx(ys,{isActive:y.pathname==="/app/@me",children:s.jsxs($e,{to:"/app/@me",children:[s.jsx(Ed,{children:s.jsx(n9,{})}),s.jsx(bs,{children:s.jsx("span",{children:"Home"})})]})}),s.jsxs(ys,{isActive:e,onClick:M,children:[s.jsx(YC,{isActive:y.pathname==="/app/friends",children:b.avatar?s.jsx("img",{src:b.avatar,alt:b.fullName}):s.jsx("div",{className:"placeholder",children:b.fullName.charAt(0).toUpperCase()})}),s.jsx(bs,{children:s.jsx("span",{children:"Profile"})})]}),s.jsxs(ys,{isActive:c,onClick:()=>d(!0),children:[s.jsxs(Ed,{children:[s.jsx(rp,{}),s.jsx("div",{className:"friend-request-length",children:m.length})]}),s.jsx(bs,{children:s.jsx("span",{children:"Notifications"})})]}),s.jsx(ys,{isActive:y.pathname.startsWith("/app/settings"),children:s.jsxs($e,{to:"/app/settings/profile",children:[s.jsx(Ed,{children:s.jsx(fp,{})}),s.jsx(bs,{children:s.jsx("span",{children:"Settings"})})]})})]})}):s.jsxs(s.Fragment,{children:[s.jsx(OC,{onClick:M,children:s.jsx(bt,{image:b.avatar,userName:b.fullName,status:b.status,showStatus:!0,showStatusCircle:!0,showUserName:!0})}),s.jsxs(BC,{children:[s.jsxs(GC,{onClick:()=>d(!0),children:[s.jsx(rp,{}),s.jsx("div",{className:"friend-request-length",children:m.length})]}),s.jsx(UC,{children:s.jsx($e,{to:"/app/settings/profile",children:s.jsx(fp,{})})})]})]})})}),s.jsx(lS,{isOpen:e,shouldAnimate:i,user:b,onLogout:j,onClose:()=>a(!1)}),s.jsx(yC,{onClose:v,isNotificationsOpen:c})]})}):null},AC=h.div`
  width: 100%;
  position: relative;
`,zC=h.div`
  width: 100%;
...
`,x7=({group:e,memberCount:a,userRole:i,isOpen:f,onClose:c})=>{const[d,m]=g.useState(!1),[y,b]=g.useState(e.name),[x,v]=g.useState(e.description||""),M=i==="admin"||i==="moderator",j=async()=>{try{console.log("Saving changes:",{name:y,description:x}),m(!1)}catch(C){console.error("Failed to update group:",C)}},k=()=>{b(e.name),v(e.description||""),m(!1)},N=C=>new Date(C).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});return s.jsx(Zf,{title:d?"Edit Group Info":"Group Info",isOpen:f,onClose:c,children:s.jsxs(M7,{children:[s.jsxs(j7,{children:[s.jsx(L7,{children:e.avatar?s.jsx(bt,{image:e.avatar,userName:e.name,size:80,isGroup:!0}):s.jsx(S7,{children:s.jsx(sp,{})})}),d?s.jsxs(I7,{children:[s.jsxs(vp,{children:[s.jsx(xp,{children:"Group Name"}),s.jsx(D7,{type:"text",value:y,onChange:C=>b(C.target.value),placeholder:"Enter group name"})]}),s.jsxs(vp,{children:[s.jsx(xp,{children:"Description"}),s.jsx(A7,{value:x,onChange:C=>v(C.target.value),placeholder:"Enter group description (optional)",rows:3})]}),s.jsxs(z7,{children:[s.jsx(yt,{variant:"cancel",title:"Cancel",onClick:k}),s.jsx(yt,{variant:"primary",title:"Save Changes",onClick:j})]})]}):s.jsxs(C7,{children:[s.jsxs(k7,{children:[s.jsx(E7,{children:e.name}),M&&s.jsx(T7,{onClick:()=>m(!0),children:s.jsx(d9,{})})]}),e.description&&s.jsx(N7,{children:e.description})]})]}),!d&&s.jsxs(R7,{children:[s.jsxs(ws,{children:[s.jsx(vs,{children:s.jsx(sp,{})}),s.jsxs(xs,{children:[s.jsx(Ms,{children:"Members"}),s.jsx(js,{children:a})]})]}),s.jsxs(ws,{children:[s.jsx(vs,{children:s.jsx(R5,{})}),s.jsxs(xs,{children:[s.jsx(Ms,{children:"Created"}),s.jsx(js,{children:N(e.createdAt)})]})]}),s.jsxs(ws,{children:[s.jsx(vs,{children:e.isPrivate?s.jsx(f9,{}):s.jsx(e9,{})}),s.jsxs(xs,{children:[s.jsx(Ms,{children:"Type"}),s.jsx(js,{children:e.isPrivate?"Private Group":"Public Group"})]})]}),s.jsxs(ws,{children:[s.jsx(vs,{children:s.jsx(J0,{})}),s.jsxs(xs,{children:[s.jsx(Ms,{children:"Created by"}),s.jsx(js,{children:e.createdBy.fullName})]})]})]})]})})},M7=h.div`
  display: flex;
  flex-direction: column;
  gap: 2rem;
`,j7=h.div`
...
`,n8=h.div`
  ...
  padding-top: 1rem;
  border-top: 1px solid ${({theme:e})=>e.border.secondary};
`,a8=({group:e,memberCount:a,userRole:i,onToggleMembersSidebar:f})=>{const[c,d]=g.useState(!1),[m,y]=g.useState(!1),[b,x]=g.useState(!1),{leaveGroup:v}=ja(),{closeChat:M}=li(),j=()=>{M&&M()},k=async()=>{try{await v(e._id),d(!1)}catch(E){console.error("Failed to leave group:",E)}},N=i==="admin"||i==="moderator",C=[{label:"Group Info",icon:s.jsx(r9,{}),onClick:()=>{y(!0),d(!1)}},...N?[{label:"Add Members",icon:s.jsx(M9,{}),onClick:()=>{x(!0),d(!1)}}]:[],{label:"Group Settings",icon:s.jsx(If,{}),onClick:()=>{d(!1),alert("Group settings not implemented yet")}},{label:"Leave Group",icon:s.jsx(ky,{}),danger:!0,onClick:k}];return s.jsxs(s.Fragment,{children:[s.jsxs(r8,{children:[s.jsx(i8,{onClick:j,children:s.jsx(Ty,{})}),s.jsxs(f8,{onClick:()=>y(!0),children:[s.jsx(o8,{children:e.avatar?s.jsx(bt,{image:e.avatar,userName:e.name,size:40,isGroup:!0}):s.jsx(s8,{children:s.jsx(Nf,{})})}),s.jsxs(l8,{children:[s.jsx(c8,{children:e.name}),s.jsxs(u8,{children:[a," member",a!==1?"s":""]})]})]}),s.jsxs(d8,{children:[s.jsx(jp,{onClick:f,title:"Show members",children:s.jsx(S9,{})}),s.jsx(jp,{onClick:()=>d(!0),title:"Group menu",children:s.jsx(Ey,{})})]}),s.jsx(Ma,{onClose:()=>d(!1),isOpen:c,right:"0",top:"100",items:C})]}),m&&s.jsx(x7,{group:e,memberCount:a,userRole:i,isOpen:m,onClose:()=>y(!1)}),b&&N&&s.jsx(B7,{group:e,isOpen:b,onClose:()=>x(!1)})]})},r8=h.header`
  width: 100%;
  padding: 1rem 1.5rem;
  border-bottom: 1px solid ${({theme:e})=>e.border.secondary};
  display: flex;
...
`,WI=h.div`
  ...
  font-size: var(--text-md);
  text-align: center;
`,Vr=({onClick:e})=>s.jsx(s.Fragment,{children:s.jsx(KI,{onClick:e,children:s.jsx(S5,{})})}),KI=h.div`
  width: 4.5rem;
  height: 4.5rem;
  border-radius: 0.8rem;
  /* box-shadow: var(--shadow-sm); */
...
`,r4=h.a`
  ...
  align-items: center;
  gap: 0.3rem;
`,w1=({title:e,onClick:a})=>s.jsx(s.Fragment,{children:s.jsxs(CA,{children:[s.jsx(kA,{onClick:a,children:s.jsx($5,{})}),s.jsx(EA,{children:s.jsx("h3",{children:e})})]})}),CA=h.div`
width: 100%;
display: grid;
...
`;function Pz(){return s.jsx(YM,{children:s.jsx(mC,{children:s.jsx(gC,{children:s.jsx(O7,{children:s.jsx(pC,{children:s.jsx(xI,{children:s.jsx(m7,{children:s.jsxs(QT,{children:[s.jsx(Hz,{}),s.jsx(Qz,{})]})})})})})})})})}fv.createRoot(document.getElementById("root")).render(s.jsx(g.StrictMode,{children:s.jsx(Pz,{})}));
